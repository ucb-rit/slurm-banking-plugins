...
impl<C: hyper::client::Connect>UseraccountassociationsApi for UseraccountassociationsApiClient<C> {
    fn useraccountassociations_list(&self, page: i32) -> Box<Future<Item = ::models::InlineResponse2002, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/useraccountassociations/?{}", configuration.base_path, query_string);
    ...
    fn useraccountassociations_partial_update(&self, id: i32, data: ::models::UserAccount) -> Box<Future<Item = ::models::UserAccount, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/useraccountassociations/{id}/?{}", configuration.base_path, query_string, id=id);
