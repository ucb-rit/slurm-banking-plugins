...
pub trait UsersApi {
    fn users_list(&self, page: i32) -> Box<Future<Item = ::models::InlineResponse2003, Error = Error<serde_json::Value>>>;
    fn users_read(&self, id: i32) -> Box<Future<Item = ::models::User, Error = Error<serde_json::Value>>>;
}
