...
pub trait AccountsApi {
    fn accounts_list(&self, page: i32) -> Box<Future<Item = ::models::InlineResponse200, Error = Error<serde_json::Value>>>;
    fn accounts_read(&self, name: &str) -> Box<Future<Item = ::models::Account, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>AccountsApi for AccountsApiClient<C> {
    fn accounts_list(&self, page: i32) -> Box<Future<Item = ::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/accounts/?{}", configuration.base_path, query_string);
    ...
    fn accounts_read(&self, name: &str) -> Box<Future<Item = ::models::Account, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/accounts/{name}/?{}", configuration.base_path, query_string, name=name);
