...
pub trait JobsApi {
    fn jobs_create(&self, data: ::models::Job, authorization: &str) -> Box<Future<Item = ::models::Job, Error = Error<serde_json::Value>>>;
    fn jobs_list(&self, page: i32) -> Box<Future<Item = ::models::InlineResponse2001, Error = Error<serde_json::Value>>>;
    fn jobs_update(&self, jobslurmid: &str, data: ::models::Job, authorization: &str) -> Box<Future<Item = ::models::Job, Error = Error<serde_json::Value>>>;
}
