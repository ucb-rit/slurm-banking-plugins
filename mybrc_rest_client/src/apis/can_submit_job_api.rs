...
pub struct CanSubmitJobApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> CanSubmitJobApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> CanSubmitJobApiClient<C> {
        CanSubmitJobApiClient {
...
impl<C: hyper::client::Connect>CanSubmitJobApi for CanSubmitJobApiClient<C> {
    fn can_submit_job_read(&self, job_cost: &str, user_id: &str, account_id: &str) -> Box<Future<Item = ::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/can_submit_job/{job_cost}/{user_id}/{account_id}/?{}", configuration.base_path, query_string, job_cost=job_cost, user_id=user_id, account_id=account_id);
