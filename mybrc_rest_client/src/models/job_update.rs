...
impl JobUpdate {
  pub fn new(jobslurmid: String) -> JobUpdate {
    JobUpdate {
  ...
  pub fn with_jobslurmid(mut self, jobslurmid: String) -> JobUpdate {
    self.jobslurmid = jobslurmid;
    self
  }
  ...
  pub fn with_submitdate(mut self, submitdate: String) -> JobUpdate {
    self.submitdate = Some(submitdate);
    self
  }
  ...
  pub fn with_startdate(mut self, startdate: String) -> JobUpdate {
    self.startdate = Some(startdate);
    self
  }
  ...
  pub fn with_enddate(mut self, enddate: String) -> JobUpdate {
    self.enddate = Some(enddate);
    self
  }
  ...
  pub fn with_userid(mut self, userid: String) -> JobUpdate {
    self.userid = Some(userid);
    self
  }
  ...
  pub fn with_accountid(mut self, accountid: String) -> JobUpdate {
    self.accountid = Some(accountid);
    self
  }
  ...
  pub fn with_amount(mut self, amount: String) -> JobUpdate {
    self.amount = Some(amount);
    self
  }
  ...
  pub fn with_jobstatus(mut self, jobstatus: String) -> JobUpdate {
    self.jobstatus = Some(jobstatus);
    self
  }
  ...
  pub fn with_partition(mut self, partition: String) -> JobUpdate {
    self.partition = Some(partition);
    self
  }
  ...
  pub fn with_qos(mut self, qos: String) -> JobUpdate {
    self.qos = Some(qos);
    self
  }
