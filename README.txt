...
~~~~~~~~~~~~~~~~~~~~~
  ...
  to generate a library to abstract away access to the API. The API is
  described by a schema file in [spec/swagger.json]. This file is
  automatically generated by the myBRC API, and can be obtained at
  `/swagger.json' on the myBRC API.
